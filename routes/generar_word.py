...
def _build_story(s: dict, S: dict) -> list:
    ...
    story.append(
        Paragraph(
            "Es importante mencionar que para seguir con el procedimiento de "
            "convalidación la persona interesada debe confirmar la aceptación del "
            "presente documento a través del correo de "
            "<b><u>admision.extraordinaria@autonomadeica.edu.pe</u></b> para lo cual tiene un "
            "plazo de 48 horas después de notificada dicha respuesta. ",
            S["body"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Términos del servicio educativo para estudios de pregrado de la UAI",
            S["titulo_anexo"],
        )
    )
    story.append(Spacer(1, 0.5 * cm))
    ...
    story.append(
        Paragraph(
            "Denominamos usuario del servicio educativo a la persona que decide"
            "voluntariamente postular, matricularse y/o convalidar en la Universidad "
            "Autónoma de Ica, en adelante, UAI y que hace efectivo dicho proceso "
            "administrativamente cancelando los derechos establecidos y presentando "
            "la ficha de inscripción y los requisitos correspondientes.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>2.&nbsp;&nbsp;Voluntariedad de los procesos:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La postulación mediante el proceso de admisión, la matrícula y la solicitud "
            "de evaluación por convalidación respectivamente, son actos voluntarios, por "
            "lo que, al ejecutar su decisión, el usuario ha recibido información, ha "
            "consultado y tiene clara la información proporcionada y vinculada nuestro "
            "servicio a nivel académico y administrativo. Así mismo, después de realizado "
            "los pagos no se harán devoluciones.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>3.&nbsp;&nbsp;Documentación Administrativa:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "LToda documentación presentada como parte del proceso de admisión, "
            "matrícula o convalidación formará parte del expediente académico del "
            "usuario y no será devuelta una vez iniciado el trámite.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>4.&nbsp;&nbsp;Tarifario y Costos Administrativos:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Los costos y procedimientos administrativos de la UAI se encuentran en el "
            "Texto Único de Procedimientos Administrativos (TUPA), publicado en el portal "
            "de transparencia de la universidad. El usuario es responsable de revisar los "
            "requisitos y las tarifas vigentes antes de realizar cualquier trámite, ya que "
            "estas pueden ser actualizadas. ",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Todos los trámites deben ser solicitados formalmente según lo establecido "
            "en el TUPA para la UAI, con la presentación de sus requisitos según se requiera ",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>6.&nbsp;&nbsp;Solicitudes no contempladas en el TUPA:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Las solicitudes de carácter académico deberán estar dirigidas y serán "
            "resueltas en primera instancia por la Dirección de su Escuela. En caso de "
            "reconsideración, la instancia superior serán las Facultades (según el "
            "programa matriculado) y como última, el Vicerrectorado Académico."
            "Las solicitudes de carácter administrativo o económico deberán estar "
            "dirigidas y serán resueltas en primera y última instancia por la Dirección "
            "Administrativa. En cualquier caso, se requiere la presentación formal de la "
            "solicitud a través de la oficina central de trámite documentario y archivo, ya "
            "sea de manera presencial (en mesa de partes) o virtual a través del correo "
            "oficial del área <b>octda@autonomadeica.edu.pe</b>. Y serán resueltas en un"
    ...
    story.append(
        Paragraph(
            "Todos los trámites deben ser solicitados formalmente según lo establecido "
            "En caso de que el usuario remita correos a instancias que no tienen "
            "considerados como recibidos por la universidad. En tales casos, se informará "
            "al usuario que debe revisar el TUPA para dirigir correctamente su solicitud o "
            "lo contemplado en el punto 6, de ser necesario.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Las normativas generales de la UAI están publicadas en nuestro portal web,"
            "así mismo podría consultarse en las plataformas académicas del usuario o "
            "solicitarse por correo institucional a su instancia académica.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>9.&nbsp;&nbsp;Comunicaciones Oficiales:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Toda comunicación oficial se remitirá al correo personal y/o institucional del "
            "usuario y a las plataformas académicas y/o página web de la universidad. "
            "Se considerará notificado el usuario 48 horas después del envío al correo.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La universidad cuenta con plataformas académicas que serán "
            "debidamente compartidos con los usuarios, para poder acceder a ellas es "
            "necesario que el usuario cuente una conexión de internet estable.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Es obligación del usuario participar en la charla inductiva y revisar los "
            "tutoriales sobre el uso de plataformas académicas. No participar se "
            "considerará como conocimiento implícito del uso adecuado de las "
            "herramientas. De esa manera, la UAI cumplió con brindar los alcances "
            "necesarios al usuario de su servicio educativo.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La universidad se reserva el derecho de actualizar y modificar los planes de "
            "estudio según su criterio académico, de conformidad con la legislación "
            "vigente, en ese sentido y de ser necesario, la UAI brindarán los lineamientos "
            "académicos para poder adecuarse a esos cambios realizados.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>13.&nbsp;&nbsp;Horarios y Modalidades de Estudio:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La universidad define las modalidades de estudio, los horarios y demás "
            "estudio según su criterio académico, de conformidad con la legislación "
            "semestre. En caso de circunstancias de fuerza mayor, los horarios podrán "
            "ajustarse tanto antes del inicio como durante el desarrollo del semestre en curso.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>14.&nbsp;&nbsp;Auditoría de Documentos:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La universidad podrá auditar la validez de los documentos presentados en "
            "cualquier momento. En caso de irregularidades, se aplicarán las sanciones "
            "correspondientes y se podrán emprender acciones pertinentes.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>15.&nbsp;&nbsp;Requisitos de Grado y Título:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "El usuario deberá informarse de los requisitos y procesos establecidos para"
            "obtener su grado académico o título profesional, contemplados en la "
            "normativa y TUPA vigente y aplicable en el momento en el que realice su "
            "proceso en la Universidad Autónoma de Ica.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "El usuario conoce los requisitos de la ley universitaria sobre el nivel y dominio "
            "de idioma según el programa de posgrado elegido en el que desea obtener "
            "el grado o título, de modificarse dicha norma, deberá adaptarse.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>17.&nbsp;&nbsp;Reprogramación de Clases:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "En casos de fuerza mayor, la universidad podrá reprogramar sesiones o "
            "reemplazar docentes con otros de igual o mayor nivel académico.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>18.&nbsp;&nbsp;Cambio de modalidad de estudios:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "En los casos en que la universidad decida que las clases presenciales, por "
            "razones de fuerza, puedan pasar a dictarse en modalidad virtual o híbrida. El "
            "usuario se compromete a contar con una conexión estable de internet y un "
            "ambiente que le permita estar y participar en las sesiones de manera satisfactoria.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>19.&nbsp;&nbsp;Postergación o cancelación de clases:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "ELa universidad se reserva el derecho de reprogramar o cancelar el inicio de "
            "clases para las convocatorias de admisión, si no se alcanza el número "
            "mínimo de participantes (25 matriculados por programa), sin perjuicio de la "
            "devolución de pagos efectuados hasta la notificación del cambio.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>20.&nbsp;&nbsp;Programación de Exámenes:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Los exámenes y sesiones especiales podrán programarse fuera del horario "
            "regular, previa comunicación al usuario.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>21.&nbsp;&nbsp;Disponibilidad de Clases Grabadas:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Las clases grabadas podrán ser revisadas en línea, pero no descargadas.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>22.&nbsp;&nbsp;Canales de Comunicación:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Toda comunicación con los docentes o las áreas académicas o "
            "administrativas de la universidad, después del proceso de admisión, será "
            "registrada mediante el correo institucional del usuario; a partir del cual "
            "nuestras áreas podrán contactarse vía telefónica o por plataforma de "
            "videoconferencia para dar atención a su correo, pudiendo terminar esta "
            "atención con un correo de respuesta que resuma la solución de su caso o "
    ...
    story.append(
        Paragraph(
            "La Universidad no recomienda ni autoriza el uso aplicaciones de mensajería "
            "instantánea (WhatsApp, Telegram principalmente) como medios de "
            "comunicación oficial para su servicio o para la interacción entre docentes y "
            "estudiantes, personal administrativo y autoridades. Cualquier información "
            "difundida en estos medios no tendrá validez académica o administrativa. "
            "Para una atención formal establecemos únicamente el correo institucional.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>24.&nbsp;&nbsp;Control de los grupos de mensajería:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La universidad deslinda responsabilidad sobre grupos de mensajería "
            "creados sin su autorización y no reconoce conversaciones en dichos "
            "cespacios como pruebas válidas en trámites académicos. "
            "La universidad comprende que, como un acto voluntario y personal, los "
            "usuarios puedan decidir formar grupos creados en aplicaciones de "
            "mensajería instantánea o también denominada “red social” pero sin el "
            "conocimiento ni autorización de esta institución, deslindando toda "
            "responsabilidad sobre el contenido compartido en dichos grupos, ya que no "
            "tiene control ni supervisión sobre los mismos, ni mucho menos en la decisión "
            "personal de sus usuarios. En consecuencia, cualquier información o "
            "conversación sostenida en estos espacios no será considerada como "
            "prueba válida en trámites con la universidad, ni será reconocida como un "
            "canal formal de comunicación o atención entre estudiantes, docentes o áreas de la universidad."
            "La Universidad no autoriza a ningún docente a exponer procedimientos y "
            "costos de trámites, sino más bien a orientar toda consulta a los portales "
            "oficiales en donde estén expuestos nuestros procedimientos",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Para poder pagar y ejercer la matrícula de un nuevo semestre, el usuario "
            "debe haber cancelado el servicio prestado del semestre anterior (valor total del semestre estudiado).",
            S["lista1"],
        )
    )
    # 26.	Del Retiro:
    ...
    story.append(
        Paragraph(
            "El usuario debe solicitar su retiro de manera formal según el procedimiento "
            "establecido en el TUPA vigente. Dicho retiro no exime de cancelar las "
            "pensiones de estudio, pues se contempla como deuda contraída. "
            "El retiro académico debe formalizarse según el procedimiento del TUPA "
            "vigente. Esto no exime al usuario de solicitar a la Dirección Administrativa "
            "cualquier pedido debidamente motivado, de manera formal",
            S["lista1"],
        )
    )
    # 27.	Medios de Pago:
    ...
    story.append(
        Paragraph(
            "Todos los pagos deben efectuarse a nombre de la Razón Social Universidad "
            "Autónoma de Ica S.A.C. mediante entidades bancarias o enlaces de pago "
            "oficiales que serán debidamente comunicados.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La Universidad cuenta con un reglamento de beneficios económicos para "
            "estudiantes de pregrado mismo que tiene por objetivo normar los "
            "procedimientos para conceder o renovar beneficios económicos.",
            S["lista1"],
        )
    )
    ...
    story.append(
        Paragraph(
            "La UAI comunicará los horarios de atención de sus áreas para una "
    ...
    story.append(
        Paragraph(
            "<b>30.&nbsp;&nbsp;Sobre las prácticas e internados:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>31.&nbsp;&nbsp;Obligatoriedad del uso de uniforme:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>32.&nbsp;&nbsp;Atención a Reclamos y Protección de Derechos Estudiantiles:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Para garantizar el bienestar y una experiencia académica de calidad para el "
            "usuario, la universidad pone a tu disposición los siguientes canales de atención:"
            "Uniformes de la Facultad, comprometiéndose a portarlo adecuadamente, "
    ...
    story.append(
        Paragraph(
            "<b>✓&nbsp;&nbsp;Defensoría Universitaria (Ley N° 30220)</b>",
            S["lista2"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Si enfrentas vulneración de derechos, maltrato o irregularidades en "
            "normativas académicas, puedes presentar tu reclamo a:<br/>"
            "<b><u>defensoria.universitaria@autonomadeica.edu.pe</u></b><br/>"
            "Horario: lunes a viernes, 9:00 am - 12:30 pm / 4:00 pm - 6:00 pm",
            S["lista3"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>✓&nbsp;&nbsp;Canal de Atención al Estudiante:</b>",
            S["lista2"],
        )
    )
    ...
    story.append(
        Paragraph(
            "Si tienes reclamos o sugerencias sobre matrícula, cursos, horarios,"
            "evaluaciones, atención del personal o problemas con plataformas "
            "digitales, principalmente (tras agotar la vía regular o instancia "
            "estipulada en el TUPA, sin respuesta en 10 días calendario), escríbenos a:<br/>"
            "<b><u>calidad@autonomadeica.edu.pe</u></b><br/>"
            "Horario: lunes a viernes, 9:00 am - 12:30 pm / 4:00 pm - 6:00 pm",
            S["lista3"],
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>33.&nbsp;&nbsp;Atención a Reclamos y Protección de Derechos Estudiantiles:</b>",
            S["lista"],
        )
    )
    ...
    story.append(
        Paragraph(
            "a) Sobre los exámenes de suficiencia: El usuario que haya recibido la "
            "respuesta a su solicitud de evaluación por traslado externo o "
            "convalidación, en la que se proponga la evaluación mediante"
            "examen de suficiencia para alguna asignatura, deberá presentarse o "
            "rendir y cancelar estos exámenes en el primer periodo académico de "
            "esta institución, conforme al cronograma y calendario informado. "
            "Cada examen tiene un costo determinado, el cual deberá ser "
            "abonado según las fechas establecidas en el cronograma. El pago de "
            "los exámenes de suficiencia no será reembolsable.",
            S["lista3"],
        )
    )
    ...
    story.append(
        Paragraph(
            "b)El usuario deberá presentarse al examen de suficiencia en la fecha "
            "programada, la cual no será reprogramada en ninguna "
            "circunstancia. En caso de no presentarse o de obtener una nota "
            "desaprobatoria, deberá cursar la asignatura de manera regular a "
            "partir del siguiente periodo académico, asumiendo los costos "
            "correspondientes. Esto provocará cambios en su proyección a académica. ",
            S["lista3"],
        )
    )
    ...
    story.append(
        Paragraph(
            "c) Si el usuario se retira del semestre, pierde automáticamente la "
            "oportunidad de presentar los exámenes de suficiencia (los que no "
            "haya pagado y rendido) y deberá cursar las asignaturas de forma de "
            "regular en el periodo académico en el que se reintegre.",
            S["lista3"],
        )
    )
    ...
    story.append(
        Paragraph(
            "d) La proyección a término es referencial: La proyección al periodo de"
            "término de los estudios de pregrado es una referencia tentativa que "
            "podría sufrir cambios, ya que está sujeta a la planificación "
            "académica de cada ciclo que es potestad de la universidad, el "
            "desempeño académico del estudiante (de no aprobar alguna "
            "asignatura, no se cumpliría con la proyección presentada en la carta) "
            "así como a la disponibilidad y registro de matrícula del estudiante, "
            "siendo este un acto voluntario y que depende exclusivamente del "
            "usuario. Es decir, la proyección presentada en su carta de respuesta "
            "es una guía más no una propuesta fáctica de la universidad. ",
            S["lista3"],
        )
    )
    ...
    story.append(
        Paragraph(
            "e)	Comunicación específica del proceso: El usuario conoce que, para el "
            "proceso de convalidación, nos contactaremos desde el área "
            "académica desde el correo institucional "
            "<b><u>admision.extraordinaria@autonomadeica.edu.pe</u></b> y de matrícula el "
            "único canal oficial es el correo institucional de la secretaria "
            "académica de su facultad, y/o correo de la dirección de su escuela"
            "profesional, y/o correo de su facultad por parte de la universidad. ",
            S["lista3"],
        )
    )
